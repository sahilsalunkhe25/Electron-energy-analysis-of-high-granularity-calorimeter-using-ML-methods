...
//out file, you can open a terminal and navigate to the directory where the file is located. Then, type "./filename. out" (replace "filename. out" with the name of your file) and press Enter.
#include <iostream>
#include <fstream>
#include <iomanip>
#include <vector>
