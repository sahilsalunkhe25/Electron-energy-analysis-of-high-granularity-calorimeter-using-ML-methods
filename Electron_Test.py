...
with open('/content/Electron_latest.pkl', 'rb') as f:
...
model=torch.load("/content/WeightElectronFile.pt")
...
print(f"Mean of Ratios: {mean_ratio}") # predicted_value / actual_value
print(f"Standard Deviation of Ratios (sigma): {std_dev_ratio}")
